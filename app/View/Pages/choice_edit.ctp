...
<div class="container">
	...
	<h3>Basic Information</h3><br>
		...
		<div class="form-group">
			...
			<?php echo $this->Form->input('name',array('class'=>'form-control','label'=>false,'value'=>$choices[0]['User']['frkUserName'],'required'=>'required')); ?>
		</div>
        ...
        <div class="form-group">
			<label>Date of Birth:(yyyy-mm-dd)<sup class="mandatory">*</sup></label>
			<?php echo $this->Form->input('dob',array('id'=>'datepicker','class'=>'form-control','placeholder'=>'yyyy-mm-dd','name'=>'dob','label'=>false,'value'=>$choices[0]['User']['frkUserDOB'],'required'=>'required')); ?>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<?php echo $this->form->input('choice.religion',array('options'=>$religions,'empty'=>'-- select religion --','class'=>'form-control','label'=>false,'value'=>$choices[0]['User']['frkUserReligion'],'required'=>'required')); ?>
		</div><br><hr style="border-top: 1px solid #93C54B;"><br>
		<div class="form-group">
			<span><font color="green"><b>Note: </b>You have to reselect the choices in order</font></span><br><br>
		...
		<?php echo $this->Form->submit('Update',array('class'=>'btn btn-success pull-right update-btn')); ?>
		<br><br>
